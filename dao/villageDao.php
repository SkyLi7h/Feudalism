...
class villageDao
{
	...
	public function getMinVillageConnexion($joueurId)
	{
		...
		$donnees = $reponse->fetch();	
		return new village($donnees["villageId"], $donnees["joueurId"], $donnees["nom"], $donnees["habitant"], $donnees["x"], $donnees["y"], $donnees["chateau"], $donnees["caserne"], $donnees["ferme"], $donnees["mine"], $donnees["scierie"], $donnees["carriere"], $donnees["metal"], $donnees["bois"], $donnees["pierre"]);
	}
}
